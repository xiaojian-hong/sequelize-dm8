...
class Query extends AbstractQuery {
  ...
  run(sql, parameters) {
    ...
    return new Utils.Promise((resolve, reject) => {
      ...
      if (parameters) {
        ...
        connection.execute(sql, parameters, handler);
      } else {
  ...
  formatResults(data) {
    ...
    if (this.isRawQuery()) {
      // dmdb returns row data and metadata (affected rows etc) in a single object - let's standarize it, sorta
      return [data, data];
    }
